    ...
    static get jsonSchema() {
        return {
            ...
            properties: {
                ...
                OrdemProducaoAcabadoCodigo: { type: "string", maxLength: 20 },
                OrdemProducaoAcabadoDescricao: { type: "string", maxLength: 50 },
                OrdemProducaoAcabadoRevId: { type: "number" },
                OrdemProducaoAcabadoRevDesc: { type: "string", maxLength: 50 },
                OrdemProducaoAcabadoTpRevId: { type: "number" },
                OrdemProducaoAcabadoTpRevDesc: { type: "string", maxLength: 50 },
